...
@ApiModel(description = "Details about the Dog") // NOTE ilker optional line to add swagger model info
public class Dog {
	@ApiModelProperty(notes = "Unique id of the Dog, which will be auto incremented by hibernate upon add(save)") // NOTE ilker optional line to add swagger model attribute info
	@Id
